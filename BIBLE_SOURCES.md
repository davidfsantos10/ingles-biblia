...
- **Não foi alterada nenhuma palavra, nem inserido espaço que não existisse por causa de uma tag.** Encontramos ~440 versículos onde a fonte oficial tem pontuação encostada na palavra seguinte sem espaço (ex.: "...aqui.Porém Davi...") — confirmamos que isso já existe assim no arquivo-fonte original (não é um artefato da nossa conversão) e **preservamos exatamente como está**, sem tentar corrigir a formatação.
